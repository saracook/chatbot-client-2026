...
Carina is Stanford University’s on-prem computing environment for [high-risk data](https://uit.stanford.edu/guide/riskclassifications.html). [Carina](carina-resources.html) leverages the Stanford Research Computing private cloud. 
