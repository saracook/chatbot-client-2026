...
Carina has three prerequisites for a new project. 
...
Carina 2.0 is certified for high-risk data, including NIH Controlled-Access Data. For detailed information, please see [FAQ: Where to use NIH-controlled access data at Stanford](https://login.scg.stanford.edu/faqs/nih_controlled_access_data/#i-use-carina-or-nero-gcp-for-nih-controlled-access-data-can-i-continue-using-either-of-them).
...
When you are ready to meet these requirements, [request a project](/request-carina-project).
